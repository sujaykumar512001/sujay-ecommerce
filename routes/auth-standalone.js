...
// Standalone login route - completely bypasses layout system
router.get("/login", (req, res) => {
  // Send the login page content directly without any layout
  const loginContent = `
<!DOCTYPE html>
<html lang="en">
<head>
...
// Standalone register route - completely bypasses layout system
router.get("/register", (req, res) => {
  // Send the register page content directly without any layout
